...
from .VideoEncoders import transformer as tvnn

class Model(nn.Module):
    def __init__(self, audio_size = (1, 257, 690), video_size=(1, 48, 360, 360),
                    num_classes=2, channel1=2, channel2=64, channel3=128, loss_type='bce',
                    kernel_size=(5, 5), padding=(2, 2), stride=(3, 3), out_dim=256):
        super(Model, self).__init__()
        self.video_enc = tvnn.VideoEnc(video_size=video_size[1:], out_dim=out_dim)
