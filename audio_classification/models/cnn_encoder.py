...
class CNN3D(nn.Module):
    def __init__(self, t_dim=24*3, img_x=360, img_y=360, drop_p=0.2, fc_hidden1=128, fc_hidden2=128, channel1=8, channels=2, 
...
class AudioCNN(nn.Module):
    def __init__(self, num_classes=2, in_size = 44100, channel1=2, channel2=64, channel3=128, 
                    kernel_size=5, padding=2, stride=8):
        ...
        self.audio = nn.Sequential(
            nn.Conv2d(channel1, channel2, (kernel_size, kernel_size), stride, padding),
            nn.BatchNorm2d(channel2),
            nn.LeakyReLU(0.2, inplace=True),
            nn.Conv2d(channel2, channel3, (kernel_size, kernel_size), stride, padding),
            nn.BatchNorm2d(channel3),
            nn.LeakyReLU(0.2, inplace=True),
            nn.Conv2d(channel3, channel2, (kernel_size, kernel_size), stride, padding),
            nn.LeakyReLU(0.2, inplace=True),
        )
        self.linear = nn.Linear(channel2*3, self.video_enc.fc_hidden2)
